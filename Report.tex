...
We run the simulations with adapting the fleet size over the scheduling horizon for both strategies. We use the same graph and vehicles' sett  As for both of them the maximum optimal fleet size is 8, we compare those strategies with 
\begin{figure}[h] 
  \centering
